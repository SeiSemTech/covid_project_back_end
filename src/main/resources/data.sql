...
insert into usuario(id, nombre, apellido, username, password, cedula, fecha_creacion, estado) VALUES(1,'name', 'lastname', 'admin', 'admin', 123456, '9999-12-31T05:00:00.000+00:00', true);
